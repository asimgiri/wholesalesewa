						...
						<div class="product-info">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-md-8">
										<ul>
											<li class="text-muted">Model : <span class="pull-right">Floral</span></li>
											<li class="text-muted">Availability : <span class="pull-right">Floral</span></li>
											<li class="text-muted">Quality : <span class="pull-right">Excellent</span></li>
										</ul>
									</div>
								</div>
							...
							<div class="description-container m-t-20">
								...
								<div class="stock-container info-container m-t-10">
									<div class="row">
										...
										<div class="col-md-8">
											<ul>
												<li class="text-muted bold">Minimum  Order : <span class="pull-right">1 Set</span></li>
												<li class="text-muted">1 Set equals : <span class="pull-right">6 Pieces</span></li>
												<li class="text-muted">Fabric Material : <span class="pull-right">In Box, Fancy</span></li>
											</ul>
										</div>
									</div><!-- /.row -->
								</div><!-- /.stock-container -->
							...
							<div class="description-container m-t-20">
								...
								<div class="stock-container info-container m-t-10">
									<div class="row">
										<div class="col-md-8">
											<ul>
												<li class="text-muted bold">Brand : <span class="pull-right">1 Set</span></li>
												<li class="text-muted">Material : <span class="pull-right">6 Pieces</span></li>
												<li class="text-muted">length : <span class="pull-right">In Box, Fancy</span></li>
											</ul>
										</div>
									</div><!-- /.row -->
								</div><!-- /.stock-container -->
