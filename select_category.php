<?php include 'includes/header.php'; ?>
  ...
  <div class="body-content outer-top-xs select_category" id="top-banner-and-menu">
    <div class="container">
      <div class="row">
        <!-- ============================================== SIDEBAR ============================================== -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 text-center">
          <div class="content">
            <h1 class="bold"><img src="assets/images/share.png" alt="" width="50px" class="mr-2">Post Your Ad</h1>
            <h4>Select the appropriate category to post your ad</h4>
            <p class="text-muted">Not Sure? Give us a missed call @ <span class="highlight1">977-9845674533</span></p>
          </div>
        </div>
      </div>
    </div>
